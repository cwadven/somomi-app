...
export const createGuestSection = async ({ title, description = null, icon = null, image_url = null, guest_section_template_id }) => {
  // POST /v1/section/guest-sections → { guest_section_id }
  return request('/v1/section/guest-sections', {
    method: 'POST',
    body: { title, description, icon, image_url, guest_section_template_id },
  });
};

export const updateGuestSection = async (guest_section_id, { title, description = null, icon = null, image_url = null, guest_section_template_id }) => {
